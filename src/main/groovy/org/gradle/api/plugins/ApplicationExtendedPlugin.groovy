 ...
 */
class ApplicationExtendedPlugin implements Plugin<Project> {
    ...
    private ApplicationExtendedPluginConvention pluginConvention
    ...
    private void addPluginConvention() {
        pluginConvention = new ApplicationExtendedPluginConvention()
